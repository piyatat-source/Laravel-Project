...
<div class="container fe">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <form method="POST" action="addInfo" aria-label="{{ __('Register') }}">
                  @csrf
                <div class="card-header"><b>รายละเอียดผู้ใช้</b></div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="username" class="col-sm-4 col-form-label text-md-right">{{ __('รหัสนักศึกษา') }}</label>
                          <div class="col-md-6">
                            <input name="stdNo" type="text" class="form-control" placeholder="ไม่ต้องใส่ขีด (-)" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                          </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                          <input name="year" type="number" class="form-control" min="1" max="4" placeholder="----- ชั้นปี -----">
                        </div>
                    </div>
